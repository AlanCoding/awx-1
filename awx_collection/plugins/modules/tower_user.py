...
def main():
    ...
    # Attempt to lookup user based on the provided name and org ID
    ...
    if state == 'absent':
        ...
        # If the state was present we can let the module build or update the existing user, this will return on its own
